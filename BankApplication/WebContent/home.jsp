...
<div id= "full">
		...
		<div id ="header">
			...
			<div id="nav">
				<ul>
					...
					<li><a href="GetStatements">getStatement</a></li>
		...
		<div id="banner"><br><br><br><br><br><br><br><br><br>
			...
			<h1 style="color:yellow;text-align: center;">to</h1>
			<h1 style="color:yellow;text-align: center;">BANK</h1>
			<h1 style="color: yellow;text-align: center;">APPLICATION</h1>

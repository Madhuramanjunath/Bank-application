...
<div id= "full">
		<div style="background-image: url('img/mm2.jpg');background-size :100% 700px; width:100%;height: 700px;" >
		<div id ="header">
			<div id="logo">
		...
		<div id="banner"><br><br><br><br><br><br><br><br><br>
			<h1 style="color: black;text-align: center;"><%out.println("We are ready to sanction loan for"); %></h1>
			<h1 style="color:black;text-align: center;"><%out.println("NAME:"+session.getAttribute("name")); %></h1>
			<h1 style="color: black;text-align: center;"><%out.println("EMAIL_ID:"+session.getAttribute("email")); %></h1>

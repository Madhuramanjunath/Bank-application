...
<div id= "full">
		<div style="background-image: url('img/pig7.jpg');background-size :100% 700px; width:100%;height: 700px;" >
		<div id ="header">
			<div id="logo">
		...
		<div id="banner"><br><br><br><br><br><br><br><br><br>
			<h1 style="color:black;text-align: center;"><%out.println("transfer made:" +session.getAttribute("al1")+"Amount Transfered :" +session.getAttribute("al2")); %></h1>
